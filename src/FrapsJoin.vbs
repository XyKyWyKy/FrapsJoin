...
'@version 1.3  15-Jan-2012     - revised output syntax
'
...
' AviSynth is free software under GNU General Public License.
    ...
    ts.WriteLine "### generated by FrapsJoin version " & VERSION & vbCrLf
    ...
    firstfile = UnQuoteString(SafeDictItem(dict, "firstfile", "AviSource(`%1%`)"))
    nextfile = UnQuoteString(SafeDictItem(dict, "nextfile", "Last + AviSource(`%1%`)"))
    postproc = UnQuoteString(SafeDictItem(dict, "postproc", "__END__"))
